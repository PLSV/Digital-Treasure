 ...
 * on 2015-11-06 at 21:59:39 UTC 
 * Modify at your own risk.
 */

package com.example.pavan.myapplication.backend.quoteEndpoint;
...
public class QuoteEndpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.20.0 of the quoteEndpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://gaebackend-1106.appspot.com/_ah/api/";
   ...
   *
   * @param content the {@link com.example.pavan.myapplication.backend.quoteEndpoint.model.Quote}
   * @return the request
   */
  public InsertQuote insertQuote(com.example.pavan.myapplication.backend.quoteEndpoint.model.Quote content) throws java.io.IOException {
    InsertQuote result = new InsertQuote(content);
    initialize(result);
    return result;
  }

  public class InsertQuote extends QuoteEndpointRequest<com.example.pavan.myapplication.backend.quoteEndpoint.model.Quote> {
     ...
     * @since 1.13
     */
    protected InsertQuote(com.example.pavan.myapplication.backend.quoteEndpoint.model.Quote content) {
      super(QuoteEndpoint.this, "POST", REST_PATH, content, com.example.pavan.myapplication.backend.quoteEndpoint.model.Quote.class);
    }
  ...
  public class ListQuote extends QuoteEndpointRequest<com.example.pavan.myapplication.backend.quoteEndpoint.model.CollectionResponseQuote> {
     ...
     */
    protected ListQuote() {
      super(QuoteEndpoint.this, "GET", REST_PATH, null, com.example.pavan.myapplication.backend.quoteEndpoint.model.CollectionResponseQuote.class);
    }
   ...
   * @return the request
   */
  public UpdateQuote updateQuote(com.example.pavan.myapplication.backend.quoteEndpoint.model.Quote content) throws java.io.IOException {
    UpdateQuote result = new UpdateQuote(content);
    initialize(result);
    return result;
  }

  public class UpdateQuote extends QuoteEndpointRequest<com.example.pavan.myapplication.backend.quoteEndpoint.model.Quote> {
     ...
     * @since 1.13
     */
    protected UpdateQuote(com.example.pavan.myapplication.backend.quoteEndpoint.model.Quote content) {
      super(QuoteEndpoint.this, "PUT", REST_PATH, content, com.example.pavan.myapplication.backend.quoteEndpoint.model.Quote.class);
    }
